...
/**
 * Created by Crilly on 29/06/2016.
 */
public class Query7Activity extends Activity {
    ...
    private class BackgroundTask extends AsyncTask<String,Object [],Object []> {
        ...
        protected Object [] doInBackground(String... strings) {
            ...
            array_final=database.comuniViciniFiume(name);
            return array_final;
        }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Query7Activity.this);
