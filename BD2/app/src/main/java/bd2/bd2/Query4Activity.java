...
public class Query4Activity extends Activity {
    ...
    private class BackgroundTask extends AsyncTask<String,Object[],Object []> {
        ...
        protected void onPostExecute(Object [] aVoid) {
            ...
            ArrayList<Polygon> comune=(ArrayList<Polygon>) array_final[0];
            ArrayList<Polyline> strade=(ArrayList<Polyline>)array_final[1];



            Graphic [] graphicComune=new Graphic[comune.size()];
            ...
            if(comune.size()!=0) {
                for (int i = 0; i < comune.size(); i++) {
                    ...
                    graphicComune[i] = new Graphic(comune.get(i), sms_comuni);
                }
